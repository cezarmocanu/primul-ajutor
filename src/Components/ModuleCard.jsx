import primAjutorOutdoor from'../assets/primAjutorOutdoor.png'

function ModuleCard (titluModul, descriereModul) {
    return(
        <div className="flex-col h-2/3 w-1/3 bg-white rounded-md drop-shadow-xl">
            ...
            <div className='flex p-3 justify-center text-lg'>{titluModul}</div> 
